                    ...
                    <div class="col-md-6">
                        ...
                        <div class="alert alert-primary" role="alert" :style="{'width': '100%', 'overflow-y': 'scroll', 'height':'300px'}">
                            <div v-for="item in ruta" :key="item.id">
                                Paso {{ i++ }}: {{ item.nombres }} ir a dirección {{ item.direccion }}
                                <br/>
                            </div>
                        </div>
